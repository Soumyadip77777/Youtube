...
function BarWithIcon({ title, icon, active = false, notification = false }: BarItemProps) {
  return (
...
function BarElement({ icon, title, active = false, notification = false }: BarItemProps) {
  return (
